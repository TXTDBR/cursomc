...
public class CursomcApplication implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		cli1.getTelefones().addAll(Arrays.asList("26363323", "89543654"));
		
		Endereco e1 = new Endereco(null, "Rua flores", "300", "apto. 203", "Jardim", "38220834", c1, cli1);
		
		Endereco e2 = new Endereco(null, "Avenida Matos", "105", "sala 800", "Centro", "38770812", c2, cli1);
